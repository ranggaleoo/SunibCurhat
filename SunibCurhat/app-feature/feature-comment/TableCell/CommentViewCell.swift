...
//  SunibCurhat
//
//  Created by Rangga Leo on 24/05/24.
...
class CommentViewCell: UITableViewCell {
    ...
    struct source {
        static var nib: UINib = UINib(nibName: String(describing: CommentViewCell.self), bundle: Bundle(for: CommentViewCell.self))
        static var identifier: String = String(describing: CommentViewCell.self)
    }
